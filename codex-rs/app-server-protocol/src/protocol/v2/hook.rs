...
v2_enum_from_core!(
    pub enum HookEventName from CoreHookEventName {
        PreToolUse, PermissionRequest, PostToolUse, PreCompact, PostCompact, SessionStart, AfterCompaction, SessionEnd, UserPromptSubmit, SubagentStart, SubagentStop, Stop
    }
);
