...
v2_enum_from_core!(
    pub enum HookEventName from CoreHookEventName {
        PreToolUse, PermissionRequest, PostToolUse, SessionStart, AfterCompaction, UserPromptSubmit, Stop
    }
);
...
pub struct ManagedHooksRequirements {
    ...
    #[ts(rename = "AfterCompaction")]
    pub after_compaction: Vec<ConfiguredHookMatcherGroup>,
...
pub struct ConfiguredHookMatcherGroup {
    ...
    pub conditions: ConfiguredHookConditions,
...
#[serde(rename_all = "camelCase")]
#[ts(export_to = "v2/")]
pub struct ConfiguredHookConditions {
    pub profile: Option<String>,
