...
impl ChatWidget {
    ...
    /// Updates the active-agent summary shown inline in the footer status line.
    ...
    fn on_collab_agent_tool_call(&mut self, item: ThreadItem) {
        let ThreadItem::CollabAgentToolCall {
            ...
            sender_thread_id,
            receiver_thread_ids,
            receiver_agents: _receiver_agents,
            prompt,
            model,
            reasoning_effort,
            agents_states,
