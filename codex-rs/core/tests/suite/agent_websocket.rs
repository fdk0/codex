...
#[test]
fn websocket_test_codex_shell_chain() -> Result<()> {
...
#[test]
fn websocket_first_turn_uses_startup_prewarm_and_create() -> Result<()> {
    run_async_test_with_large_stack(|| async {
        skip_if_no_network!(Ok(()));
...
#[test]
fn websocket_first_turn_handles_handshake_delay_with_startup_prewarm() -> Result<()> {
    run_async_test_with_large_stack(|| async {
        skip_if_no_network!(Ok(()));
...
#[test]
fn websocket_v2_test_codex_shell_chain() -> Result<()> {
    run_async_test_with_large_stack(|| async {
        skip_if_no_network!(Ok(()));
...
#[test]
fn websocket_v2_first_turn_uses_updated_fast_tier_after_startup_prewarm() -> Result<()> {
    run_async_test_with_large_stack(|| async {
        skip_if_no_network!(Ok(()));
...
#[test]
fn websocket_v2_first_turn_drops_fast_tier_after_startup_prewarm() -> Result<()> {
    run_async_test_with_large_stack(|| async {
        skip_if_no_network!(Ok(()));
...
#[test]
fn websocket_v2_next_turn_uses_updated_service_tier() -> Result<()> {
    run_async_test_with_large_stack(|| async {
        skip_if_no_network!(Ok(()));
