...
use codex_config::HookConditions as CoreHookConditions;
...
fn map_hook_matcher_group_to_api(group: CoreMatcherGroup) -> ConfiguredHookMatcherGroup {
    ConfiguredHookMatcherGroup {
        ...
        conditions: map_hook_conditions_to_api(group.conditions),
        hooks: group
            .hooks
            .into_iter()
...
fn map_hook_conditions_to_api(conditions: CoreHookConditions) -> ConfiguredHookConditions {
    ConfiguredHookConditions {
        profile: conditions.profile,
        profiles: conditions.profiles,
        model: conditions.model,
        models: conditions.models,
        permission_mode: conditions.permission_mode,
        permission_modes: conditions.permission_modes,
    }
}
